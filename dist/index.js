...
$(function () {
    $.ajax({
        ...
        window.title = '今天，你“绿”了没？';
        window.desc = '动动手指，就能为西北荒漠种下一片绿林，快和小伙伴一起“绿”起来吧！';
        window.link = location.href.split('#')[0];
        window.imgUrl = 'http://www.iwitech.com.cn/earch-environmental-day/assets/icon/heater.jpg';
    window.share = function shareDesc(shareData) {
        wx.ready(function () {
            oMS(shareData);
        });
